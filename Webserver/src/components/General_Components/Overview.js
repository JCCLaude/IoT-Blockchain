    ...
    return (
      ...
      {/*   <div className="flex-container" id="logo">
        ...
        <Card border="dark" bg="secondary" style={{ width: '18rem' }}>
          <Card.Body>
            <Card.Title><b>IBES</b></Card.Title>
            <Card.Text>
        ...
        <Card border="dark" bg="secondary" style={{ width: '18rem' }}>
          <Card.Body>
            <Card.Title><b>Powerplant</b></Card.Title>
            <Card.Text>
        ...
        <Card border="dark" bg="secondary" style={{ width: '18rem' }}>
          <Card.Body>
            <Card.Title><b>IoT sensors</b></Card.Title>
            <Card.Text>
        ...
        <Card border="dark" bg="secondary" style={{ width: '18rem' }}>
          <Card.Body>
            <Card.Title><b>Website</b></Card.Title>
            <Card.Text>
        ...
        <Card border="dark">
          <Card.Body>
            <Card.Title><b>About IBES</b></Card.Title>
            <Card.Text>
