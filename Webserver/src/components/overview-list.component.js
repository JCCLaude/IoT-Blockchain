...
import CO2List from './co-list.component';
...
var notext1 = ""; var notext2 = ""; var notext3 = ""; var noimg=greenthumbup; var noalt = "Green Thumb Up"; var noemissions = "";
...
export default class OverviewList extends Component {
 ...
 //   test = certboolCO2.toString();
    ...
    if(!certificateboolOverview) {thumb_img = redcert;
      ...
      notext3 = "with the government emission limits:"; noimg = redcert; noalt = "Red Thumb Down"; 
      noemissions = "CO2, SF6";
    }
  }
  ...
  render() {
    return (
      <div> 
        ...
        <p><img src={thumb_img} width="130" height="120" alt={thumb_alt} /> {text1} <b>{textyesorno}</b> {text2} </p>
        ...
        <div className="flex-container"><img id="overview_structure" src={Overview_structure} width="750" height="470" alt=""></img></div>
        <p>The <b>IBES</b> uses IoT sensors that measure emissions from <b>powerplant</b> or industrial sites and store this data securely through <b>blockchain</b> technology. This data is then made freely available to anyone on the Internet on a <b>website</b>. </p>
          

        <div class="flex-box" id="overview_img_txt_cont">
          <div class="flex-item1"><p>The <b>powerplant</b> emits emissions whose actual values are not immediately accessible to everyone. We would like to use IBES to check whether these emissions actually remain below the legal limits.</p></div>
          <div class="flex-item2"><p>The <b>IoT sensors</b> measure different emissions such as greenhouse gases, which are harmful to our climate and health. The IoT sensors are placed directly at the power plant itself and at the surrounding <b>Villages</b> to get the most realistic overall impression of the emissions.</p></div>
          <div class="flex-item3"><p>The <b>blockchain</b> stores the collected IoT data securely. No one can change the data unnoticed, because the data is accessible to everyone and changes are visible to everyone.</p></div>
          <div class="flex-item4"><p>The data in the blockchain can be viewed by anyone at any time on the IBES <b>website on their computer or mobile phone</b> on the Internet. Here, all collected data is listed both graphically and in tabular form.</p></div>
        </div>
