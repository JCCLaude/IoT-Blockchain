...
import airhumidityimg from "../../images/airhumidity.jpg";
import temperatureimg from "../../images/temperature.jpg";
import no2img from "../../images/no2.jpg";
import pm2img from "../../images/pm2.jpg";
import pm10img from "../../images/pm10.jpg";
import so2img from "../../images/so2.jpg";
  ...
  const fetchEvents = async () => {
    axios.get("http://localhost:5000/co/")
      .then((response) => {
        ...
        var test; var i=0;
        for(i=0;i<covals.length-1;i++){if(parseInt(covals[i]) > colimitred){console.log("danger!! "+covals[i])}}
        var CO2message={
      ...
      <>
        ...
        <div className="container">
          <article>
            ...
            <p>
              All data measured by the IoT sensors is stored centrally in a database. 
              These can all be viewed here. 
              This data includes the measured values, the date and time, and the location of the measurement. 
            </p>
          ...
          <div className="row">
            <div class="col-sm-4">
                ...
                <img class="card-img-top" src={co2img} width="150" height="150" alt="CO2 image"></img>
                  <Card.Header><b>Carbon Dioxide</b></Card.Header>
                  <Card.Body>Here you will find a link to the Carbon Dioxide (CO2) webside.</Card.Body>
                  <Link to="/detail/carbondioxide">
                    <Button size="md" variant="info" block>CO2</Button>
                  </Link>
                </Card>
            </div>  
            ...
            <div class="col-sm-4">
              ...
              <img class="card-img-top" src={airhumidityimg} width="150" height="150" alt="Air Humidity Image"></img>
                <Card.Header><b>Air Humidity</b></Card.Header>
                <Card.Body>Here you will find a link to the Air Humidity webside.</Card.Body>
                <Link to="/detail/airhumidity">
                  <Button size="md" variant="info" block>Air Humidity</Button>
                </Link>
              </Card>
            </div>  
            ...
            <div class="col-sm-4">  
              ...
              <img class="card-img-top" src={temperatureimg} width="150" height="150" alt="Temperature Image"></img>
                <Card.Header><b>Temperature</b></Card.Header>
                <Card.Body>Here you will find a link to the Temperature webside.</Card.Body>
                <Link to="/detail/temperature">
                  <Button size="md" variant="info" block>Temperature</Button>
                </Link>
              </Card>
            </div>  
            ...
            <div class="col-sm-4">
              ...
              <img class="card-img-top" src={no2img} width="150" height="150" alt="NO2 Image"></img>
                <Card.Header><b>Nitrogen Dioxide</b></Card.Header>
                <Card.Body>Here you will find a link to the Nitrogen Dioxide (NO2) webside.</Card.Body>
                <Link to="/detail/nitrogendioxide">
                  <Button size="md" variant="info" block>Nitrogen Dioxide</Button>
                </Link>
              </Card>
            </div>  
            ...
            <div class="col-sm-4">
              ...
              <img class="card-img-top" src={pm2img} width="150" height="150" alt="PM2.5 Image"></img>
                <Card.Header><b>Particular Matter 2.5</b></Card.Header>
                <Card.Body>Here you will find a link to the Particular Matter 2.5 (PM2.5) webside.</Card.Body>
                <Link to="/detail/particularmatter2">
                  <Button size="md" variant="info" block>Particular Matter 2.5</Button>
                </Link>
              </Card>
            </div>  
            ...
            <div class="col-sm-4">
              ...
              <img class="card-img-top" src={pm10img} width="150" height="150" alt="PM10 Image"></img>
                <Card.Header><b>Particular Matter 10</b></Card.Header>
                <Card.Body>Here you will find a link to the Particular Matter 10 (PM10) webside.</Card.Body>
                <Link to="/detail/particularmatter10">
                  <Button size="md" variant="info" block>Particular Matter 10</Button>
                </Link>
              </Card>
            </div>  
            ...
            <div class="col-sm-4 mx-auto">
                ...
                <img class="card-img-top" src={so2img} width="150" height="150" alt="SO2 Image"></img>
                  <Card.Header><b>Sulfur Dioxdie</b></Card.Header>
                  <Card.Body>Here you will find a link to the Sulfur Dioxdie (SO2) webside.</Card.Body>
                  <Link to="/detail/sulfurdioxdie">
                    <Button size="md" variant="info" block>Sulfur Dioxdie</Button>
                  </Link>
                </Card>
            </div>  
          </div>    
