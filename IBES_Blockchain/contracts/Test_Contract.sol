...
contract Test_Contract {
    ...
    string higher_limit_message = "Higher Test limit exceeded!";

    int8 lower_limit = 28;
    string lower_limit_message = "Lower Test limit exceeded!";

    string no_limit_message = "No Test limit exceeded.";
    ...
    function reflect(int8 _measurement) public returns(int8){
        measurement = _measurement;
        return measurement;
    }
}